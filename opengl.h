...
API PFNGLCLEARCOLORPROC pglClearColor;
#define glClearColor pglClearColor
API PFNGLVIEWPORTPROC pglViewport;
...
API PFNGLGENVERTEXARRAYSPROC pglGenVertexArrays;
#define glGenVertexArrays pglGenVertexArrays
API PFNGLBINDVERTEXARRAYPROC pglBindVertexArray;
#define glBindVertexArray pglBindVertexArray
API PFNGLVERTEXATTRIBPOINTERPROC pglVertexAttribPointer;
#define glVertexAttribPointer pglVertexAttribPointer
API PFNGLENABLEVERTEXATTRIBARRAYPROC pglEnableVertexAttribArray;
#define glEnableVertexAttribArray pglEnableVertexAttribArray
API PFNGLDRAWARRAYSPROC pglDrawArrays;
#define glDrawArrays pglDrawArrays
API PFNGLDRAWELEMENTSPROC pglDrawElements;
#define glDrawElements pglDrawElements
API PFNGLCREATEPROGRAMPROC pglCreateProgram;
#define glCreateProgram pglCreateProgram
API PFNGLUSEPROGRAMPROC pglUseProgram;
#define glUseProgram pglUseProgram
API PFNGLDELETEPROGRAMPROC pglDeleteProgram;
#define glDeleteProgram pglDeleteProgram
API PFNGLLINKPROGRAMPROC pglLinkProgram;
#define glLinkProgram pglLinkProgram
API PFNGLVALIDATEPROGRAMPROC pglValidateProgram;
#define glValidateProgram pglValidateProgram
API PFNGLCREATESHADERPROC pglCreateShader;
#define glCreateShader pglCreateShader
API PFNGLSHADERSOURCEPROC pglShaderSource;
#define glShaderSource pglShaderSource
API PFNGLCOMPILESHADERPROC pglCompileShader;
#define glCompileShader pglCompileShader
API PFNGLATTACHSHADERPROC pglAttachShader;
#define glAttachShader pglAttachShader
API PFNGLDELETESHADERPROC pglDeleteShader;
#define glDeleteShader pglDeleteShader
API PFNGLGETSHADERIVPROC pglGetShaderiv;
#define glGetShaderiv pglGetShaderiv
API PFNGLGETSHADERINFOLOGPROC pglGetShaderInfoLog;
#define glGetShaderInfoLog pglGetShaderInfoLog
API PFNGLGETPROGRAMIVPROC pglGetProgramiv;
#define glGetProgramiv pglGetProgramiv
API PFNGLGETUNIFORMLOCATIONPROC pglGetUniformLocation;
#define glGetUniformLocation pglGetUniformLocation
API PFNGLGETPROGRAMINFOLOGPROC pglGetProgramInfoLog;
#define glGetProgramInfoLog pglGetProgramInfoLog
API PFNGLUNIFORM1FPROC pglUniform1f;
#define glUniform1f pglUniform1f
API PFNGLUNIFORM3FPROC pglUniform3f;
#define glUniform3f pglUniform3f
API PFNGLUNIFORM4FPROC pglUniform4f;
#define glUniform4f pglUniform4f
API PFNGLUNIFORM1IPROC pglUniform1i;
#define glUniform1i pglUniform1i
API PFNGLUNIFORM3FVPROC pglUniform3fv;
